...
JAZZMIN_SETTINGS = {
    "site_title": "Liquor Store",
    "site_header": "Liquor Store",
    "site_brand": "Liquor Store",
    "site_icon": "images/favicon.png",
    # Add your own branding here
    "site_logo": None,
    "welcome_sign": "Welcome to the Liquor Store",
    # Copyright on the footer
    "copyright": "Liquor Store",
    "user_avatar": None,
    ############
    # Top Menu #
    ############
    ...
    "topmenu_links": [
        ...
        {"name": "Liquor Store", "url": "home", "permissions": ["auth.view_user"]},
